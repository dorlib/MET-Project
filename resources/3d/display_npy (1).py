...
class Viewer:
    ...
    def show_image(self,show_all = True, opacity=0.7, colormap="gray",  mask_opacity = 0.4, mask_colormap = None):
        if show_all:
    ...
    def visualize_mask(self, mask_path: str, label_colors=None, opacity=0.7):
        """
        Add mask alongside the loaded image and ground truth mask.
        """
        ...
        mask_layer = self.viewer.add_labels(mask, name="GT MASK", opacity=opacity, colormap =glas)
