...
high_res_viz_content = '''#!/usr/bin/env python3
...
with open('high_res_viz_fixed.py', 'w') as f:
    f.write(high_res_viz_content)
    
print("Fixed high_res_viz.py file created. Now copy it into the container.")
